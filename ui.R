...
rightsidebar <- rightSidebar( icon = "desktop",
  ...
  selectizeInput("filtro_geral",
                 label = NULL,
                 choices = c("GRANDE OESTE" = "1",
                             "MEIO OESTE E SERRA CATARINENSE" = "2",
                             "FOZ DO RIO ITAJAÍ" = "3",
                             "VALE DO ITAJAÍ" = "4",
                             "GRANDE FLORIANOPOLIS" = "5",
                             "SUL" = "6",
                             "PLANALTO NORTE E NORDESTE" = "7"),
                 selected = unique(banco_macro_saude_analise$macrorregiao),
                 multiple = T,
                 width = "100%")
)
